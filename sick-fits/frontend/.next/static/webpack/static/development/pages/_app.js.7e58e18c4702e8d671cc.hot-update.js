...
function (_React$Component) {
  ...
  function RemoveFromCart() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "update", function (cache, payload) {
      console.log("running RFC update Fn"); // read the cache

      var data = cache.readQuery({
        query: _User_js__WEBPACK_IMPORTED_MODULE_5__["CURRENT_USER_QUERY"]
      });
      console.log(data); // remove that item from cart
...
//# sourceMappingURL=_app.js.7e58e18c4702e8d671cc.hot-update.js.map